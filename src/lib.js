...
//jimili:二次开发，暴露一些工具 start
import  createNewMeasurement from './tools/annotation/bidirectionalTool/createNewMeasurement.js'
import  pointNearTool from './tools/annotation/bidirectionalTool/pointNearTool.js'
import  renderToolData from './tools/annotation/bidirectionalTool/renderToolData.js'
import  addNewMeasurement from './tools/annotation/bidirectionalTool/addNewMeasurement.js'
import  moveCallback from './tools/annotation/bidirectionalTool/mouseMoveCallback.js'
import  handleSelectedCallback from './tools/annotation/bidirectionalTool/handleSelectedCallback.js'
import  handleSelectedMouseCallback from './tools/annotation/bidirectionalTool/handleSelectedMouseCallback.js'
import  handleSelectedTouchCallback from './tools/annotation/bidirectionalTool/handleSelectedTouchCallback.js'

import  calculateLongestAndShortestDiameters from './tools/annotation/bidirectionalTool/utils/calculateLongestAndShortestDiameters.js'
...
export const lib = {
  ...
  //jimili:二次开发
  'bidirectionalTool/createNewMeasurement':createNewMeasurement,
  'bidirectionalTool/pointNearTool':pointNearTool,
  'bidirectionalTool/renderToolData':renderToolData,
  'bidirectionalTool/addNewMeasurement':addNewMeasurement,
  'bidirectionalTool/mouseMoveCallback':moveCallback,
  'bidirectionalTool/handleSelectedCallback':handleSelectedCallback,
  'bidirectionalTool/handleSelectedMouseCallback':handleSelectedMouseCallback,
  'bidirectionalTool/handleSelectedTouchCallback':handleSelectedTouchCallback,

  'calculateLongestAndShortestDiameters':calculateLongestAndShortestDiameters,
  'util/getCircleCoords':getCircleCoords,

  'pointInEllipse':pointInEllipse,
  'calculateEllipseStatistics':calculateEllipseStatistics,

  'hideToolCursor':hideToolCursor,
  'setToolCursor':setToolCursor,
